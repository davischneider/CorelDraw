...
public class Zoom {
    ...
    public static BufferedImage process(BufferedImage image, double sizeX, double sizeY) {
        BufferedImage resultImage = new BufferedImage(image.getWidth(), image.getHeight(), image.getType());
        transform(image, resultImage, sizeX, sizeY);
        return resultImage;
    }

    public static void transform(BufferedImage image, BufferedImage resultImage, double sizeX, double sizeY) {
